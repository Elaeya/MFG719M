...
prob = optimproblem('Objective', 5.3*1.11*x1 + 17.44*1.11*x2 + 12.1*1.11*x3 + 9*1.11*x4 + ...
    37.4*1.11*y1 + 21.3*1.11*y2 + 16*1.11*y3 + 31.2*1.11*y4 + 143.13*1.11*w1 + 142.14*1.11*w2 + ...
    25.74*1.11*w3 + 16.6*1.11*w4, 'ObjectiveSense', 'min');
